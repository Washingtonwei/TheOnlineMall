...
<ul id="summary">
	...
	<li id="summary-market"><div class="dt">Product id：</div><div class="dd"><span>${item.id }</span></div></li>
	<li id="summary-grade">
		<div class="dt">Product Review：</div>
		<div class="dd">
			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn">
							<a class="btn-append " id="InitCartUrl" href="/cart/add/${item.id}.html" clstag="shangpin|keycount|product|initcarturl">Add to cart<b></b></a>
					</div>
