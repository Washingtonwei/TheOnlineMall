...
<div class="w" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span>Already registered, I want to &nbsp;
        	<a href="/page/login" class="flk13">Log on</a>
        </span>
        </div>
    </div>
    <div class="mc">
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
					...
					<div class="item" id="dphone">
						<span class="label"><b class="ftx04">*</b>Cellphone:</span>
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">I have read and agree with<a href="#" class="blue" id="protocol">《淘淘用户注册协议》</a></label>
                        <span class="clr"></span>
                        <label id="protocol_error" class="error hide">Accept Agreement</label>
                    </div>
                </div>
                <div class="item">
                    <span class="label">&nbsp;</span>
